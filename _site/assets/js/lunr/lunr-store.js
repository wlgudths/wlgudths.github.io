var store = [{
        ...
        "excerpt":"명제 (Proposition) 논리학적으로 뜻이 분명한 문장을 말한다. 즉, 참(True) 혹은 거짓(False) 으로 구분할 수 있는 문장이나 수식이다. 명제는 통상 영문 소문자 $p$, $q$, $r$, $\\cdots$ 등으로 표기 명제 예시 손흥민이 태어난 년도는 2000년이다. 손흥민이 태어난 년도는 1992년이므로 거짓인 명제이다. 1 + 2 = 3 산수에 원리에 따라 객관적으로 참, 거짓을...","categories": ["Math"],
        "tags": [],
        "url": "/math/Math-03/",
        "teaser": null
      }]
